...
/** Minimal markdown-to-HTML converter. Handles bold, italic, inline code, code blocks, lists, and line breaks. */
function renderMarkdown(text: string): string {
  ...
  html = html.replace(
    /^# (.+)$/gm,
    '<h2 class="font-bold text-base mt-2 mb-1">$1</h2>'
  );

  // Line breaks (but not inside <pre>)
  html = html.replace(/\n/g, '<br/>');

  // Clean up double <br/> after block-level elements
